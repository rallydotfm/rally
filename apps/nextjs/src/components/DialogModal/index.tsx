    ...
    <Dialog open={isOpen} onClose={() => setIsOpen(false)} className="relative z-50">
      ...
      <div className="fixed inset-0 flex items-center justify-center 2xs:p-4">
        ...
        <div className="flex min-h-full w-full items-center justify-center">
          ...
          <Dialog.Panel className="text-sm mx-auto min-h-screen max-h-screen overflow-y-auto 2xs:min-h-[auto] 2xs:max-h-[calc(100vh-60px)] w-full max-w-screen-2xs border px-4 pt-4 pb-6 border-neutral-4 grid grid-cols-1 bg-black 2xs:rounded-lg">
